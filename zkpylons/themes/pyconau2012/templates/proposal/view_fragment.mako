...
<p>
<em>Extended (reviewer only) Abstract:</em>
</p>
<blockquote>
...
<p>I allow ${ c.config.get("event_parent_organisation") } to record my presentation.</p>

<p>${ allow(c.proposal.video_release) } ${ c.config.get("event_parent_organisation") } to release any
recordings of my presentation under the <a href="${ c.config.get("media_license_url") }">${ c.config.get("media_license_name") }</a></p>

<p>${ allow(c.proposal.slides_release) } ${ c.config.get("event_parent_organisation") } to release any other material (such as slides) from my presentation under the <a href="${ c.config.get("media_license_url") }">${ c.config.get("media_license_name") }</a>
</p>
