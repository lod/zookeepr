...
%for proposal_type in c.proposal_types:
  ...
  <table id="${ proposal_type.name }" class="table sortable">
    <tr>
      <th>#</th>
      <th>Proposal</th>
      <th>Submitters</th>
...
<%    proposal = result.Proposal %>
    ...
    <tr class="${ h.cycle('even', 'odd') }">
      ...
      <td>
        ...
        <div id="${ "proposal%s" % proposal.id }" class="biodiv"><strong>Abstract:</strong><p>${ proposal.abstract | h.line_break }</p></pre></div>
      </td>
      <td>
