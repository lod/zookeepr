<%page args="fulfilment" />
    ...
    <p><b>Void:</b> ${ h.yesno(fulfilment.is_void) }<br></p>
    <p><b>Completed:</b> ${ h.yesno(fulfilment.is_completed) }<br></p>
    <p><b>Locked:</b> ${ h.yesno(fulfilment.is_locked) }<br></p>
    <p><b>Can Edit:</b> ${ h.yesno(fulfilment.can_edit) }<br></p>
    <table>
      <tr>
        <th>Product</th>
        <th>Product Text</th>
